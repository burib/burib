...
# --- hand-added: present on the machine but missed by `brew bundle dump` ---
# go compiler (needed for the `go "..."` package lines above)
brew "go"
...
# this line (and the charmbracelet trust in setup_mac.sh) is added by hand
